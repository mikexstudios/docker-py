...
class DockerClientTest(Cleanup, base.BaseTestCase):
    ...
    def test_tar_with_excludes(self):
        ...
        for d in ['dir1/dir2', 'dir3']:
            ...
            for f in ['a.txt', 'b.py', 'c.py', 'other.png', 'dir3']: #dir3 is a file here
        ...
        for exclude, names in (
                ...
                # wildcard exclude
                (['*'], []), 
                # FAILING: exclude everything in current directory
                #(['.'], []), 
                # FAILING: single filename
                ...
                (['*.py'], [i for i in initial if i not in 
                            ['dir1/dir2/b.py', 'dir1/dir2/c.py', 
                             'dir3/b.py', 'dir3/c.py']]),
                # FAILING: ambiguous directory (should also exclude the filename 'dir3')
                #(['dir3'], [i for i in initial if i not in 
                #            ['dir1/dir2/dir3', 
                #             'dir3', 'dir3/a.txt', 'dir3/b.py', 'dir3/c.py',
                #             'dir3/dir3', 'dir3/other.png']]),
                # FAILING: directory with trailing slash
                #(['dir3/'], [i for i in initial if i not in 
                #            ['dir3', 'dir3/a.txt', 'dir3/b.py', 'dir3/c.py',
                #             'dir3/dir3', 'dir3/other.png']]),
                # FAILING: nested directory
                ...
                (['*.py', 'dir3'], [i for i in initial if i not in 
                            ['dir1/dir2/b.py', 'dir1/dir2/c.py',
                             'dir3', 'dir3/a.txt', 'dir3/b.py', 'dir3/c.py',
                             'dir3/dir3', 'dir3/other.png']]),
                # FAILING: single filename and explicit nested directory
